...
<<<<<<< HEAD:drivers/input/touchscreen/synaptics_dsx2/rmi_dev.c
	retval = rmi4_data->i2c_read(rmi4_data,
=======
...
>>>>>>> 2e348833f33ea1902b3986d8b77836588bc665d7:drivers/input/touchscreen/synaptics_dsx/synaptics_dsx_rmi_dev.c
			*f_pos,
			tmpbuf,
			count);
	if (retval < 0)
